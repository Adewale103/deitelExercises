...
public class StudentGradeUpdated {
    ...
    public static void main(String[] args) {
        ...
        printTable(studentsNumber, subjectsNumber);
        printSubjectSummary(studentsNumber, subjectsNumber);

    }

    public static void printSubjectSummary(int studentsNumber, int subjectNumber) {
        System.out.println("SUBJECT SUMMARY");
        for (int i = 0; i < subjectNumber; i++) {
            subjectSummary(array, studentsNumber, i);
        }
        System.out.println(hardestSubject());
        System.out.println(easiestSubject());
        System.out.println(overHighestScore(subjectNumber, studentsNumber));
        System.out.println(overLowestScore(subjectNumber, studentsNumber));
        printShape();
        classSummary(total, studentsNumber);
    }

    public static void enterGrade(int studentsNumber, int subjectsNumber) {
        array = new int[studentsNumber][subjectsNumber];
        totalPass = new int[subjectsNumber];
        totalFail = new int[subjectsNumber];
        student = new int[studentsNumber][1];
        total = new int[studentsNumber][1];
        average = new double[studentsNumber][1];
        position = new int[studentsNumber][1];
        tempPosition = new int[studentsNumber][2];
    ...
    public static void printTable(int studentsNumber, int subjectsNumber) {
        printShape();
        System.out.println();
